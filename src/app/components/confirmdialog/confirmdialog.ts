		...
		<div [ngClass]="{'ui-dialog ui-confirmdialog ui-widget ui-widget-content ui-corner-all ui-shadow':true,'ui-dialog-rtl':rtl}"
			...
			<div class="ui-dialog-footer ui-widget-content">
				<div class="ui-dialog-buttonpane ui-helper-clearfix" *ngIf="!footer">
					<button type="button" pButton [icon]="rejectIcon" [label]="rejectLabel" (click)="reject()"
					        *ngIf="rejectVisible"></button>
					<button type="button" pButton [icon]="acceptIcon" [label]="acceptLabel" (click)="accept()"
					        *ngIf="acceptVisible"></button>
				</div>
			</div>
    `,
    animations: [
